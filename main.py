...
API_ID = 30324289  # ضع الـ api_id هنا
API_HASH = "93e20ced9ed0fa7e7e903900c11633d6"  # ضع الـ api_hash هنا
BOT_TOKEN = "8817608659:AAF8O-I58x-khZLq4AzY-OWTyfgPIcNEo1M"  # توكن البوت من @BotFather

# =============== جلسات المستخدمين ===============
user_sessions = {}  # {user_id: {"client": client, "phone": str, "step": str}}
